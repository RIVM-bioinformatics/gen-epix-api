...
- You can invoke Explorer for rapid file/usage discovery if research scope is large (>10 potential files)
...
- Delegate to Explorer if >10 files need discovery (avoid loading unnecessary context)
