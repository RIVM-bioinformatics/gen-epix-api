...
class TestIsoTimeTransformer:
    """Test cases for IsoTimeTransformer."""

    def test_transform_iso_time(self) -> None:
        ...
        # YEAR tests
        test_cases[
            (TimeUnit.YEAR, TimeUnit.YEAR, TimeUnitTransformStrategy.EXACT_ONLY)
        ] = [
            ("2024", "2024"),
        ]
        test_cases[
        ...
        test_cases[
            (TimeUnit.YEAR, TimeUnit.WEEK, TimeUnitTransformStrategy.EXACT_ONLY)
        ] = [
            ("2024", None),
        ]
        test_cases[
            (TimeUnit.YEAR, TimeUnit.DAY, TimeUnitTransformStrategy.EXACT_ONLY)
        ] = [
            ("2024", None),
        ]
        ...
        test_cases[
            (TimeUnit.MONTH, TimeUnit.DAY, TimeUnitTransformStrategy.EXACT_ONLY)
        ] = [
            ("2024-01", None),
        ]
        ...
        test_cases[
            (TimeUnit.WEEK, TimeUnit.YEAR, TimeUnitTransformStrategy.EXACT_ONLY)
        ] = [
            ("2020-W52", "2020"),
            ("2020-W53", None),
            ("2022-W52", None),
        ...
        test_cases[
            (TimeUnit.WEEK, TimeUnit.WEEK, TimeUnitTransformStrategy.EXACT_ONLY)
        ] = [
            ("2024-W01", "2024-W01"),
        ]
        test_cases[
            (TimeUnit.WEEK, TimeUnit.DAY, TimeUnitTransformStrategy.EXACT_ONLY)
        ] = [
            ("2024-W01", None),
        ]
        ...
        # DAY tests
        test_cases[
            (TimeUnit.DAY, TimeUnit.YEAR, TimeUnitTransformStrategy.EXACT_ONLY)
        ] = [
            ("2023-01-01", "2023"),
        ]
        test_cases[
        ...
        test_cases[
            (TimeUnit.DAY, TimeUnit.MONTH, TimeUnitTransformStrategy.EXACT_ONLY)
        ] = [
            ("2023-01-01", "2023-01"),
        ]
        test_cases[
            (TimeUnit.DAY, TimeUnit.WEEK, TimeUnitTransformStrategy.EXACT_ONLY)
        ] = [
            ("2021-01-01", "2020-W53"),
            ("2021-01-02", "2020-W53"),
            ("2021-01-03", "2020-W53"),
        ...
        test_cases[
            (TimeUnit.DAY, TimeUnit.DAY, TimeUnitTransformStrategy.EXACT_ONLY)
        ] = [
        ...
        for (src_unit, tgt_unit, strategy), test_data in test_cases.items():
            ...
            actual_outputs = test_time_transform(
                src_unit, tgt_unit, strategy, input_values
            )
            assert_equal(actual_outputs, expected_outputs)

    def test_tgt_field(self) -> None:
