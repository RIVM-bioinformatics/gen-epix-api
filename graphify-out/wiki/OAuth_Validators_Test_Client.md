...
- **Validate authorization code (not used in client credentials flow).** (1 connections) — `test/test_client/oauth/validators.py`
- **Confirm redirect URI (not used in client credentials flow).** (1 connections) — `test/test_client/oauth/validators.py`
- **Validate that the grant type is supported by the client.** (1 connections) — `test/test_client/oauth/validators.py`
- **Validate bearer token and scopes.** (1 connections) — `test/test_client/oauth/validators.py`
- *... and 12 more nodes in this community*

## Relationships

- [Client](Client.md) (19 shared connections)
