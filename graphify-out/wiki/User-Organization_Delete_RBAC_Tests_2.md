# User/Organization Delete RBAC Tests

> 9 nodes · cohesion 0.33

## Key Concepts

- **TestDelete** (8 connections) — `test/omopdb/integration/build_db/delete.py`
- **Env** (4 connections)
...
- **RBAC permissions: - root: CRUD - app_admin: R - refdata_admin: R - org_admin: R…** (1 connections) — `test/omopdb/integration/build_db/delete.py`
