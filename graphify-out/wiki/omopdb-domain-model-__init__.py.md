...
- **DrugExposure** (10 connections) — `gen_epix/omopdb/domain/model/omop/clinical_data.py`
- **Note** (10 connections) — `gen_epix/omopdb/domain/model/omop/clinical_data.py`
- **ProcedureOccurrence** (10 connections) — `gen_epix/omopdb/domain/model/omop/clinical_data.py`
- **CareSite** (10 connections) — `gen_epix/omopdb/domain/model/omop/health_system.py`
...
- [omop/ontology.py](omop-ontology.py.md) (30 shared connections)
- [validate_int_for_uuid_field](validate_int_for_uuid_field.md) (24 shared connections)
- [derived.py](derived.py.md) (21 shared connections)
- [seqdb/domain/model/__init__.py](seqdb-domain-model-__init__.py.md) (17 shared connections)
- [entity.py](entity.py.md) (16 shared connections)
- [model/omop/upload.py](model-omop-upload.py.md) (14 shared connections)
- [test_omopdb_model.py](test_omopdb_model.py.md) (9 shared connections)
- [commondb/domain/enum.py](commondb-domain-enum.py.md) (9 shared connections)
- [test_get_full_persons_by_person_ids.py](test_get_full_persons_by_person_ids.py.md) (8 shared connections)
- [ModelNoId](ModelNoId.md) (7 shared connections)
