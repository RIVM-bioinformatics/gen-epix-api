# Allele Hamming Distance Kernels
...
- **.test_int32_and_numpy_batch_produce_same_distances_as_python_loop()** (5 connections) — `test/seqdb/unit/services/seq/calculate_seq_distance/test_seqdb_calculate_seq_distance.py`
...
- **_py()** (1 connections) — `test/seqdb/unit/services/seq/calculate_seq_distance/test_seqdb_calculate_seq_distance.py`

## Relationships

- [Sequence Distance Calculation](Sequence_Distance_Calculation.md) (8 shared connections)
- [Seq Distance Calculation Tests](Seq_Distance_Calculation_Tests.md) (5 shared connections)
