# Protocol/Data Collection Creation Tests

> 52 nodes · cohesion 0.09

## Key Concepts

- **TestCreate** (52 connections) — `test/seqdb/integration/build_db/create.py`
- **Env** (48 connections)
...
- **.test_create_assembly_protocol()** (2 connections) — `test/seqdb/integration/build_db/create.py`
- **.test_create_ast_protocol()** (2 connections) — `test/seqdb/integration/build_db/create.py`
