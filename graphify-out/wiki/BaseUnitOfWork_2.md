...
> God node · 241 connections · `gen_epix/fastapp/unit_of_work.py`

**Community:** [BaseUnitOfWork](BaseUnitOfWork.md)
...
- [test_seqdb_calculate_seq_distance.py](test_seqdb_calculate_seq_distance.py.md) `EXTRACTED`
...
- [test_seqdb_retrieve_best.py](test_seqdb_retrieve_best.py.md) `EXTRACTED`
...
- [case_date.py](case_date.py.md) `EXTRACTED`

### inherits
- [SAUnitOfWork](SAUnitOfWork.md) `EXTRACTED`
