# OIDC Requestor Test App

> 52 nodes · cohesion 0.05

## Key Concepts

- **RequestorApp** (24 connections) — `test/end_to_end/client_credential_flow/apps/requestor_app.py`
...
- [OAuth Flow Integration Tests](OAuth_Flow_Integration_Tests.md) (12 shared connections)
...
- [Receiver App CLI](Receiver_App_CLI.md) (1 shared connections)
