...
- **RoleGenerator** (5 connections) — `gen_epix/seqdb/domain/policy/permission.py`
...
- [commondb/domain/enum.py](commondb-domain-enum.py.md) (8 shared connections)
...
- [ReadUserPolicy](ReadUserPolicy.md) (3 shared connections)
