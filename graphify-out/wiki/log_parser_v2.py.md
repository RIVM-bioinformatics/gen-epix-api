...
- **RegexFilter** (16 connections) — `gen_epix/filter/regex.py`
...
- [commondb/domain/enum.py](commondb-domain-enum.py.md) (13 shared connections)
- [composite.py](composite.py.md) (10 shared connections)
- [Filter](Filter.md) (8 shared connections)
- [CompositeFilter](CompositeFilter.md) (6 shared connections)
- [StringSetFilter](StringSetFilter.md) (5 shared connections)
- [Run](Run.md) (5 shared connections)
- [LogParser2](LogParser2.md) (3 shared connections)
- [casedb/domain/command/__init__.py](casedb-domain-command-__init__.py.md) (3 shared connections)
- [.get_test_client](get_test_client.md) (2 shared connections)
- [test_filter_base_filter.py](test_filter_base_filter.py.md) (1 shared connections)
- [CasedbTestClient](CasedbTestClient.md) (1 shared connections)
- [test/test_client/util.py](test-test_client-util.py.md) (1 shared connections)
