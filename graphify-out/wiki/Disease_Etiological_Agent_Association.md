# Disease Etiological Agent Association
...
- **Etiology** (1 connections)
- **Update etiological agent associations for a disease.** (1 connections) — `gen_epix/casedb/services/remote_app.py`
