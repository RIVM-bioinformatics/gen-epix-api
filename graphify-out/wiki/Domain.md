...
- **.get_crud_command_for_model()** (5 connections) — `gen_epix/fastapp/domain/domain.py`
- **.get_dag_sorted_models()** (5 connections) — `gen_epix/fastapp/domain/domain.py`
- **.get_permission()** (5 connections) — `gen_epix/fastapp/domain/domain.py`
- **._link_new_entity_and_model()** (5 connections) — `gen_epix/fastapp/domain/domain.py`
- *... and 43 more nodes in this community*

## Relationships

- [Entity](Entity.md) (26 shared connections)
- [Permission](Permission.md) (22 shared connections)
- [CrudOperation](CrudOperation.md) (12 shared connections)
- [TestRegistrationAndLookups](TestRegistrationAndLookups.md) (3 shared connections)
- [CrudCommand](CrudCommand.md) (3 shared connections)
