...
- **.n_contigs()** (2 connections) — `gen_epix/seqdb/domain/model/seq/seq.py`
...
- **Self** (1 connections)
- **A contiguous DNA sequence. Any IUPAC ambiguity codes are allowed in the…** (1 connections) — `gen_epix/seqdb/domain/model/seq/seq.py`
- **A DNA sequence, typically representing an assembled genome or a part thereof. A…** (1 connections) — `gen_epix/seqdb/domain/model/seq/seq.py`

## Relationships

- [entity.py](entity.py.md) (15 shared connections)
- [convert](convert.md) (2 shared connections)
- [validate_int_enum_value](validate_int_enum_value.md) (2 shared connections)
- [.create_seq_for_upload](create_seq_for_upload.md) (1 shared connections)
