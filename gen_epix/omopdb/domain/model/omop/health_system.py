...
class CareSite(Model):
    ...
    care_site_id: UUID = Field(
        description="User guidance:\nAssign an id to each combination of a location and nature of the site.\nETL conventions:\nNone"
    )
    ...
    # Custom extension - not part of standard OMOP
    site_id: UUID | None = Field(
        default=None,
        description="User guidance:\nNot part of OMOP CDM. Foreign key to Site table (custom extension).\nETL conventions:\nNone",
    )
