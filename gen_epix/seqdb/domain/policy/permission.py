...
class RoleGenerator(CommonRoleGenerator):
    ...
    ROLE_PERMISSION_SETS = {
        ...
        | {
            ...
            (command.AlleleProfileIdentifierCrudCommand, PermissionTypeSet.CRUD),
            ...
            (command.KmerProfileIdentifierCrudCommand, PermissionTypeSet.CRUD),
            ...
            (command.LocusProfileIdentifierCrudCommand, PermissionTypeSet.CRUD),
            (command.LocusSetCrudCommand, PermissionTypeSet.R),
            (command.MlvaProfileCrudCommand, PermissionTypeSet.CRUD),
            (command.MlvaProfileIdentifierCrudCommand, PermissionTypeSet.CRUD),
            ...
            (command.SnpProfileIdentifierCrudCommand, PermissionTypeSet.CRUD),
