...
def seq_service_crud_mlva_profile(
    self: BaseSeqService, cmd: command.MlvaProfileCrudCommand
) -> (
    ...
    """Handle CRUD operations for MlvaProfile entities."""
    user_id = cmd.user.id if cmd.user else None
    mlva_profiles: list[model.MlvaProfile] = cmd.get_objs()  # type: ignore[assignment]
    if cmd.is_create():
