...
def seq_service_crud_mlva_profile_identifier(
    self: BaseSeqService, cmd: command.MlvaProfileIdentifierCrudCommand
) -> (
    ...
    """Handle CRUD operations for MlvaProfileIdentifier entities."""
    user_id = cmd.user.id if cmd.user else None
    mlva_profile_identifiers: list[model.MlvaProfileIdentifier] = cmd.get_objs()  # type: ignore[assignment]
    if cmd.is_create():
