...
def seq_service_crud_allele_alignment(
    self: BaseSeqService, cmd: command.AlleleAlignmentCrudCommand
) -> (
    ...
    """Handle CRUD operations for AlleleAlignment entities."""
    user_id = cmd.user.id if cmd.user else None
    allele_alignments: list[model.AlleleAlignment] = cmd.get_objs()  # type: ignore[assignment]
    if cmd.is_create():
