...
def seq_service_crud_kmer_profile(
    self: BaseSeqService, cmd: command.KmerProfileCrudCommand
) -> (
    ...
    """Handle CRUD operations for KmerProfile entities."""
    user_id = cmd.user.id if cmd.user else None
    kmer_profiles: list[model.KmerProfile] = cmd.get_objs()  # type: ignore[assignment]
    if cmd.is_create():
