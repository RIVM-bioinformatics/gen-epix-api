"""Implement seqdb CRUD service operations for services.seq.crud_sample_identifier."""
...
def seq_service_crud_sample_identifier(
    ...
    """Handle CRUD operations for sample identifier entities.

    Args:
        self: Sequence service executing the command.
        cmd: Typed sample-identifier CRUD command.
