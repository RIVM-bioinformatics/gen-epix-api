...
def seq_service_crud_locus_profile_identifier(
    self: BaseSeqService, cmd: command.LocusProfileIdentifierCrudCommand
) -> (
    ...
    """Handle CRUD operations for LocusProfileIdentifier entities."""
    user_id = cmd.user.id if cmd.user else None
    locus_profile_identifiers: list[model.LocusProfileIdentifier] = cmd.get_objs()  # type: ignore[assignment]
    if cmd.is_create():
