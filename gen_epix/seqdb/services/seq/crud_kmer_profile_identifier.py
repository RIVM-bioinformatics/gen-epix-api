...
def seq_service_crud_kmer_profile_identifier(
    self: BaseSeqService, cmd: command.KmerProfileIdentifierCrudCommand
) -> (
    ...
    """Handle CRUD operations for KmerProfileIdentifier entities."""
    user_id = cmd.user.id if cmd.user else None
    kmer_profile_identifiers: list[model.KmerProfileIdentifier] = cmd.get_objs()  # type: ignore[assignment]
    if cmd.is_create():
