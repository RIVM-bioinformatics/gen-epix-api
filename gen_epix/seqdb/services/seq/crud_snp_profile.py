...
def seq_service_crud_snp_profile(
    self: BaseSeqService, cmd: command.SnpProfileCrudCommand
) -> (
    ...
    """Handle CRUD operations for SnpProfile entities."""
    user_id = cmd.user.id if cmd.user else None
    snp_profiles: list[model.SnpProfile] = cmd.get_objs()  # type: ignore[assignment]
    if cmd.is_create():
