...
def seq_service_crud_ref_snp_set(
    self: BaseSeqService, cmd: command.RefSnpSetCrudCommand
) -> (
    ...
    """Handle CRUD operations for RefSnpSet entities."""
    user_id = cmd.user.id if cmd.user else None
    ref_snp_sets: list[model.RefSnpSet] = cmd.get_objs()  # type: ignore[assignment]
    if cmd.is_create():
