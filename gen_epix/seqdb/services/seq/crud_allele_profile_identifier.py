...
def seq_service_crud_allele_profile_identifier(
    self: BaseSeqService, cmd: command.AlleleProfileIdentifierCrudCommand
) -> (
    ...
    """Handle CRUD operations for AlleleProfileIdentifier entities."""
    user_id = cmd.user.id if cmd.user else None
    allele_profile_identifiers: list[model.AlleleProfileIdentifier] = cmd.get_objs()  # type: ignore[assignment]
    if cmd.is_create():
