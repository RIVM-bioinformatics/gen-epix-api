"""Define persisted attribute-based access-control models for commondb.

The organization-admin policy links a user to an organization and records
whether the user may exercise organization-administration capabilities there.
"""
