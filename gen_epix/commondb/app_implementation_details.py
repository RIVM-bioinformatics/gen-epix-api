...
class AppImplementationDetails(BaseModel):
    """
    ...
    role_generator_class: Type[RoleGenerator] = Field(
        description="Class used for generating permissions"
    )
    ...
    role_map: dict[enum.Role | Enum, str] = Field(
        description="Mapping of roles to their string representations",
    )
    role_set_map: dict[enum.RoleSet | Enum, frozenset[str]] = Field(
        description="Mapping of role sets to their corresponding sets of role strings",
    )
